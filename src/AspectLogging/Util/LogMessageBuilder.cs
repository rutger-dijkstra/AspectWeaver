...
namespace AspectLogging.Util {
  ...
  public static class LogMessageBuilder {
    ...
    public static Action<ILogger, LogLevel, Exception> Define(EventId eventId, string formatString) {
      var formatter = CreateLogValuesFormatter(formatString, expectedNamedParameterCount: 0);

      return (logger, logLevel, exception) => {
    ...
    /// <param name="formatString">The named format string</param>
    /// <returns>A delegate which when invoked creates a log message.</returns>
    public static Action<ILogger, LogLevel, T1, Exception> Define<T1>(EventId eventId, string formatString) {
      var formatter = CreateLogValuesFormatter(formatString, expectedNamedParameterCount: 1);

      return (logger, logLevel, arg1, exception) => {
        if( logger.IsEnabled(logLevel) ) {
    ...
    /// <param name="formatString">The named format string</param>
    /// <returns>A delegate which when invoked creates a log message.</returns>
    public static Action<ILogger, LogLevel, T1, T2, Exception> Define<T1, T2>(EventId eventId, string formatString) {
      var formatter = CreateLogValuesFormatter(formatString, expectedNamedParameterCount: 2);

      return (logger, logLevel, arg1, arg2, exception) => {
        if( logger.IsEnabled(logLevel) ) {
    ...
    /// <param name="formatString">The named format string</param>
    /// <returns>A delegate which when invoked creates a log message.</returns>
    public static Action<ILogger, LogLevel, T1, T2, T3, T4, Exception> Define<T1, T2, T3, T4>(EventId eventId, string formatString) {
      var formatter = CreateLogValuesFormatter(formatString, expectedNamedParameterCount: 4);

      return (logger, logLevel, arg1, arg2, arg3, arg4, exception) => {
        if( logger.IsEnabled(logLevel) ) {
    ...
    /// <param name="formatString">The named format string</param>
    /// <returns>A delegate which when invoked creates a log message.</returns>
    public static Action<ILogger, LogLevel, T1, T2, T3, T4, T5, Exception> Define<T1, T2, T3, T4, T5>(EventId eventId, string formatString) {
      var formatter = CreateLogValuesFormatter(formatString, expectedNamedParameterCount: 5);

      return (logger, logLevel, arg1, arg2, arg3, arg4, arg5, exception) => {
        if( logger.IsEnabled(logLevel) ) {
    ...
    /// <param name="formatString">The named format string</param>
    /// <returns>A delegate which when invoked creates a log message.</returns>
    public static Action<ILogger, LogLevel, T1, T2, T3, T4, T5, T6, Exception> Define<T1, T2, T3, T4, T5, T6>(EventId eventId, string formatString) {
      var formatter = CreateLogValuesFormatter(formatString, expectedNamedParameterCount: 6);

      return (logger, logLevel, arg1, arg2, arg3, arg4, arg5, arg6, exception) => {
        if( logger.IsEnabled(logLevel) ) {
    ...
    private class LogValues: IReadOnlyList<KeyValuePair<string, object>> {
      ...
      private static readonly object[] _valueArray = new object[0];
